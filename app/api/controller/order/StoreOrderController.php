...
class StoreOrderController
{
    ...
    public function computedOrder(Request $request, $key)
    {
        ...
        $priceGroup["SurplusIntegral"]=(string)$priceGroup["SurplusIntegral"];
        $priceGroup["coupon_price"]=(string)$priceGroup["coupon_price"];
        $priceGroup["pay_postage"]=(string)$priceGroup["pay_postage"];
        $priceGroup["pay_price"]=(string)$priceGroup["pay_price"];
        $priceGroup["deduction_price"]=(string)$priceGroup["deduction_price"];
